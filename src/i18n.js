...
const STRINGS = {
    en: {
        ...
        imgReading: 'Reading barcode…',
        imgOcr: 'Reading text…',
        scanCameraNote: 'Reads a barcode that contains the ID number (e.g. the green ID book, or an ID printed as a barcode on a form). The new smart-card barcode is encrypted and may not be readable. Uploaded photos also fall back to reading the printed number (OCR).',
        scanNotFound: 'No valid ID number found. Try a clearer photo or type it in.',
    ...
    zu: {
        ...
        uploadImage: 'Layisha isithombe se-ID',
        imgReading: 'Ifunda ibhakhodi…',
        imgOcr: 'Ifunda umbhalo…',
        scanCameraNote: 'Ifunda ibhakhodi equkethe inombolo ye-ID (isb. incwadi yesazisi eluhlaza, noma i-ID enyatheliswe njengebhakhodi). Ibhakhodi yekhadi elihlakaniphile elisha ibhalwe ngemfihlo futhi kungenzeka ingafundeki. Izithombe ezilayishiwe nazo zizama ukufunda inombolo enyathelisiwe (OCR).',
        scanNotFound: 'Ayikho inombolo ye-ID evumelekile etholakele. Zama isithombe esicacile noma uyithayiphe.',
    ...
    af: {
        ...
        uploadImage: 'Laai ID-foto op',
        imgReading: 'Lees strepieskode…',
        imgOcr: 'Lees teks…',
        scanCameraNote: '’n Strepieskode wat die ID-nommer bevat word gelees (bv. die groen ID-boek, of ’n ID wat as strepieskode gedruk is). Die nuwe slimkaart se strepieskode is geënkripteer en is dalk nie leesbaar nie. Opgelaaide foto’s val ook terug op die lees van die gedrukte nommer (OCR).',
        scanNotFound: 'Geen geldige ID-nommer gevind nie. Probeer ’n duideliker foto of tik dit in.',
